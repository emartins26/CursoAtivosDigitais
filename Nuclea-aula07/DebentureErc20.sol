...
/**
 * @title Debenture padrão ERC20
 * @dev Operacoes de uma debenture
 * @author Elisa Martins
 */

 //** Número do contrato: 0xA017c823DE91f228813BF6f55Ab37d9A06Ba5D3D */
...
/// @title ERC-20 Debenture template

contract DebentureERC20 is IERC20, Ownable {
    ...
    constructor(string memory emissor_) {
        myName = "Token Nuclea Series 05 2024";
        mySymbol = "NC052024";
        decimals = 2;
